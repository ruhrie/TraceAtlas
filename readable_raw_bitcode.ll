...
Body:                                             ; preds = %Loop
  %0 = call i32 @rand() #0
  %1 = call i32 @MemoryRead(i32 0)
  %2 = inttoptr i32 %1 to i32**
  %3 = load i32*, i32** %2
  %4 = call i32 @MemoryRead(i32 1)
  %5 = inttoptr i32 %4 to i32*
  %6 = load i32, i32* %5
  %7 = sext i32 %15 to i64
  %8 = getelementptr inbounds i32, i32* %14, i64 %16
  store i32* %8, i32** @2
  %9 = call i32 @MemoryWrite(i32 1)
  %10 = inttoptr i32 %9 to i32*
  store i32 %0, i32* %10
  %11 = call i32 @MemoryRead(i32 1)
  %12 = inttoptr i32 %11 to i32*
  %13 = load i32, i32* %12
  %14 = add nsw i32 %18, 1
  %15 = call i32 @MemoryWrite(i32 0)
...
Body:                                             ; preds = %Loop
  %0 = call i32 @MemoryRead.1(i32 0)
  %1 = inttoptr i32 %0 to i32**
  %2 = load i32*, i32** %1
  %3 = call i32 @MemoryRead.1(i32 2)
  %4 = inttoptr i32 %3 to i32*
  %5 = load i32, i32* %4
  %6 = sub nsw i32 %23, 1
  %7 = sext i32 %24 to i64
  %8 = getelementptr inbounds i32, i32* %22, i64 %25
  store i32* %8, i32** @6
  %9 = call i32 @MemoryRead.1(i32 3)
  %10 = inttoptr i32 %9 to i32*
  %11 = load i32, i32* %10
  %12 = call i32 @MemoryRead.1(i32 0)
  %13 = inttoptr i32 %12 to i32**
  %14 = load i32*, i32** %13
  %15 = call i32 @MemoryRead.1(i32 2)
  %16 = inttoptr i32 %15 to i32*
  %17 = load i32, i32* %16
  %18 = sext i32 %29 to i64
  %19 = getelementptr inbounds i32, i32* %28, i64 %30
  store i32* %19, i32** @7
  %20 = call i32 @MemoryRead.1(i32 4)
  %21 = inttoptr i32 %20 to i32*
  %22 = load i32, i32* %21
  %23 = add nsw i32 %27, %32
  %24 = call i32 @MemoryRead.1(i32 0)
  %25 = inttoptr i32 %24 to i32**
  %26 = load i32*, i32** %25
  %27 = call i32 @MemoryRead.1(i32 2)
  %28 = inttoptr i32 %27 to i32*
  %29 = load i32, i32* %28
  %30 = add nsw i32 %35, 1
  %31 = sext i32 %36 to i64
  %32 = getelementptr inbounds i32, i32* %34, i64 %37
  store i32* %32, i32** @8
  %33 = call i32 @MemoryRead.1(i32 5)
  %34 = inttoptr i32 %33 to i32*
  %35 = load i32, i32* %34
  %36 = add nsw i32 %33, %39
  %37 = call i32 @MemoryRead.1(i32 1)
  %38 = inttoptr i32 %37 to i32**
  %39 = load i32*, i32** %38
  %40 = call i32 @MemoryRead.1(i32 2)
  ...
  store i32* %45, i32** @9
  %46 = call i32 @MemoryWrite.2(i32 1)
  %47 = inttoptr i32 %46 to i32*
  store i32 %36, i32* %47
  %48 = call i32 @MemoryRead.1(i32 2)
  %49 = inttoptr i32 %48 to i32*
  %50 = load i32, i32* %49
  %51 = add nsw i32 %46, 1
  %52 = call i32 @MemoryWrite.2(i32 0)
