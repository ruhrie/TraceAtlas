...
namespace TraceAtlas::tik
{
    ...
    private:
        CartographerKernel();
        void GetBoundaryValues(std::set<llvm::BasicBlock *> &blocks, std::map<int64_t, llvm::BasicBlock *> &IDToBlock, std::map<int64_t, llvm::Value *> &IDToValue);
        ...
        void RemapExports(llvm::ValueToValueMapTy &VMap, std::map<int64_t, llvm::Value *> &IDToValue);
